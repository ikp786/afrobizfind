                                            ...
                                            <tbody>
                                              <tr>
                                                <td valign="top" class="textContent">
                                                  <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:20px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Invoice</div>
                                                </td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        ...
                                        <td valign="top" class="textContent">
                                          ...
                                          <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                          		...
                                          		<div style="display: block; width: 100%">
                                          			<div style="    display: inline-block;">Hi {{ $company->user->first_name }} {{ $company->user->surname }} <br> <br> </div>

                                          		</div>
                                          		<div style="display: block; width: 100%">
                                          			<div style="    display: inline-block;">Here's company profile monthly charge invoice. </div>
                                                <div style="    display: inline-block;"> 
                                                   Company number: {{ $company->company_number  }}<br>
                                                   Company name: {{ $company->company_name }}<br>
                                                   <span>
                                                      Duration:- {{ $company->duration_start }} to {{ $company->duration_end }}
                                                   </span><br><br>
                                                </div>
                                          		...
                                          		<div style="display: block; width: 100%">
                                          			...
                                          			<div style="    display: inline-block;"> Best regards<br>
                                                  Afrobizfind
                                                </div>
